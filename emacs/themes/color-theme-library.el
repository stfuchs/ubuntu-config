...
(defun color-theme-midnight-mod ()
  ...
  (color-theme-install
   '(color-theme-midnight-mod
     ((font . "fixed")
      ...
      (cursor-color . "grey85"))
     (default ((t (nil))))
     (font-lock-comment-face ((t (:italic t :foreground "dodger blue"))))
     (font-lock-string-face ((t (:foreground "gold"))))
     (font-lock-keyword-face ((t (:foreground "Cyan"))))
     (font-lock-warning-face ((t (:bold t :foreground "Pink"))))
     (font-lock-constant-face ((t (:foreground "lime green"))))
     (font-lock-type-face ((t (:underline t :foreground "dim gray"))))
     (font-lock-variable-name-face ((t (:foreground "dark orange"))))
     (font-lock-function-name-face ((t (:bold t :foreground "royal blue"))))
